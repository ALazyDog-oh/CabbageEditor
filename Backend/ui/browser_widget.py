...
from .dock_widget import AddDock, RemoveDock
...
class BrowserWidget(QWebEngineView):
    ...
    def connect_signals(self):
        # Prefer snake_case handlers; keep CamelCase wrappers for compatibility
        try:
            self.bridge.create_route.connect(self.add_dock_widget)
        except Exception:
            self.bridge.create_route.connect(self.AddDockWidget)
        try:
            self.bridge.remove_route.connect(self.remove_dock_widget)
        except Exception:
    ...
    def add_dock_widget(self, routename, routepath, position, floatposition, size):
    ...
    # legacy CamelCase kept for compatibility
    ...
    def closeEvent(self, event):
        try:
            ...
            try:
                self.bridge.create_route.disconnect(self.add_dock_widget)
            except Exception:
                try:
                    ...
                    pass
            try:
                self.bridge.remove_route.disconnect(self.remove_dock_widget)
            except Exception:
                try:
